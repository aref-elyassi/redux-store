...
const Signup = () => {
  return (
    <div>
      ...
      <button type="button" className="btn btn-outline-primary ms-2" data-bs-toggle="modal" data-bs-target="#sinupModal">
        <span className='fa fa-user-plus'></span> Sign Up
      </button>

      <div className="modal fade" id="sinupModal" tabIndex="-1" aria-labelledby="sinupModal" aria-hidden="true">
